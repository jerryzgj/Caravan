...
def listen_then_recognize():
    ...
    with  sr.Microphone() as source:
        r.adjust_for_ambient_noise(source)  # listen for 1 second to calibrate the e
        print("Say the move!")
    ...
    return r.recognize_sphinx(audio,language="chess-EN-Nato", grammar="chess_nato.gram")# return a result of recognition
...
def format_speech(recognized_text):
    ...
    if from_number=="SIX":
        from_number=6
    if from_number=="SEVEN":
        from_number=7
    if from_number=="EIGHT":
        from_number=8
    if to_number=="ONE":
        to_number=1
    if to_number=="TWO":
    ...
    #print (to_number)
    #splitted_text = ""
    if from_letter=="ALPHA":
        from_letter='A'       
    if from_letter=="BRAVO":
        from_letter='B'
    if from_letter=="CHARLIE":
        from_letter='C'
    if from_letter=="DELTA":
        from_letter='D' 
    if from_letter=="ECHO":
        from_letter='E'       
    if from_letter=="FOXTROT":
        from_letter='F'
    if from_letter=="GOLF":
        from_letter='G'
    if from_letter=="HOTEL":
        from_letter='H'
    ...
    if to_letter=="BRAVO":
        to_letter='B'
    if to_letter=="CHARLIE":
        to_letter='C'
    if to_letter=="DELTA":
        to_letter='D' 
    if to_letter=="ECHO":
        to_letter='E'       
    if to_letter=="FOXTROT":
        to_letter='F'
    if to_letter=="GOLF":
        to_letter='G'
    if to_letter=="HOTEL":
